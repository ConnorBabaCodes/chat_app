 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ne(){return window}function oL(t){Ne().location.href=t}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ng(){return typeof Ne().WorkerGlobalScope<"u"&&typeof Ne().importScripts=="function"}async function aL(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function uL(){var t;return((t=navigator==null?void 0:navigator.serviceWorker)===null||t===void 0?void 0:t.controller)||null}function lL(){return Ng()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _d=eT("rcb"),TL=new Eu(3e4,6e4),kL="https://www.google.com/recaptcha/api.js?";class CL{constructor(){var e;this.hostLanguage="",this.counter=0,this.librarySeparatelyLoaded=!!(!((e=Ne().grecaptcha)===null||e===void 0)&&e.render)}load(e,n=""){return k(NL(n),e,"argument-error"),this.shouldResolveImmediately(n)?Promise.resolve(Ne().grecaptcha):new Promise((r,i)=>{const s=Ne().setTimeout(()=>{i(Qe(e,"network-request-failed"))},TL.get());Ne()[_d]=()=>{Ne().clearTimeout(s),delete Ne()[_d];const a=Ne().grecaptcha;if(!a){i(Qe(e,"internal-error"));return}const u=a.render;a.render=(l,c)=>{const h=u(l,c);return this.counter++,h},this.hostLanguage=n,r(a)};const o=`${kL}?${Qs({onload:_d,render:"explicit",hl:n})}`;ZS(o).catch(()=>{clearTimeout(s),i(Qe(e,"internal-error"))})})}clearedOneInstance(){this.counter--}shouldResolveImmediately(e){var n;return!!(!((n=Ne().grecaptcha)===null||n===void 0)&&n.render)&&(e===this.hostLanguage||this.counter>0||this.librarySeparatelyLoaded)}}function NL(t){return t.length<=6&&/^\s*[a-zA-Z0-9\-]*\s*$/.test(t)}class AL{async load(e){return new _L(e)}clearedOneInstance(){}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oM=new Eu(3e4,6e4);function bw(){const t=Ne().___jsl;if(t!=null&&t.H){for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}}function aM(t){return new Promise((e,n)=>{var r,i,s;function o(){bw(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{bw(),n(Qe(t,"network-request-failed"))},timeout:oM.get()})}if(!((i=(r=Ne().gapi)===null||r===void 0?void 0:r.iframes)===null||i===void 0)&&i.Iframe)e(gapi.iframes.getContext());else if(!((s=Ne().gapi)===null||s===void 0)&&s.load)o();else{const a=eT("iframefcb");return Ne()[a]=()=>{gapi.load?o():n(Qe(t,"network-request-failed"))},ZS(`https://apis.google.com/js/api.js?onload=${a}`).catch(u=>n(u))}}).catch(e=>{throw Il=null,e})}let Il=null;function uM(t){return Il=Il||aM(t),Il}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var P$=it.exports,O$=Symbol.for("react.element"),L$=Symbol.for("react.fragment"),M$=Object.prototype.hasOwnProperty,$$=P$.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,F$={key:!0,ref:!0,__self:!0,__source:!0};function wT(t,e,n){var r,i={},s=null,o=null;n!==void 0&&(s=""+n),e.key!==void 0&&(s=""+e.key),e.ref!==void 0&&(o=e.ref);for(r in e)M$.call(e,r)&&!F$.hasOwnProperty(r)&&(i[r]=e[r]);if(t&&t.defaultProps)for(r in e=t.defaultProps,e)i[r]===void 0&&(i[r]=e[r]);return{$$typeof:O$,type:t,key:s,ref:o,props:i,_owner:$$.current}}Ch.Fragment=L$;Ch.jsx=wT;Ch.jsxs=wT;(function(t){t.exports=Ch})(kh);const U$=kh.exports.Fragment,Te=kh.exports.jsx,di=kh.exports.jsxs;tn.initializeApp({apiKey:"AIzaSyC_9SoTNzMscQB51k6wxrsVKdbxCjlvhow",authDomain:"chatapp-13c12.firebaseapp.com",projectId:"chatapp-13c12",storageBucket:"chatapp-13c12.appspot.com",messagingSenderId:"153525367282",appId:"1:153525367282:web:f4e38e3fa2ff1b08f67b6b"});const Ri=tn.auth(),V$=tn.firestore();function B$(){const[t]=T$(Ri);return di("div",{className:"App",children:[di("header",{children:[Te("h1",{children:"React Chat Room"}),Te(j$,{})]}),Te("section",{children:t?Te(q$,{}):Te(z$,{})})]})}function z$(){function t(){const n=new tn.auth.GoogleAuthProvider;Ri.signInWithPopup(n)}function e(){$S(Ri).then(()=>{new tn.auth})}return di("div",{children:[Te("h1",{className:"welcomeText",children:"Welcome to React Chat Room"}),Te("h2",{className:"welcomeText",children:"This is a single room chatroom app built in React with a firebase backend."}),Te("button",{onClick:t,children:"Sign in with Google"}),Te("div",{children:Te("button",{onClick:e,className:"guest",children:"Continue as guest"})})]})}function j$(){return Ri.currentUser&&Te("button",{onClick:()=>Ri.signOut(),children:"Sign Out"})}function q$(){const t=Td.useRef(),e=V$.collection("messages"),n=e.orderBy("createdAt").limit(1e3),[r]=b$(n,{idField:"id"}),[i,s]=Td.useState(""),o=async a=>{a.preventDefault();const{uid:u,photoURL:l}=Ri.currentUser;await e.add({text:i,createdAt:tn.firestore.FieldValue.serverTimestamp(),uid:u,photoURL:l}),s(""),t.current.scrollIntoView({behavior:"smooth"})};return di(U$,{children:[di("main",{children:[r&&r.map(a=>Te(W$,{message:a},a.id)),Te("div",{ref:t})]}),di("form",{onSubmit:o,children:[Te("input",{required:!0,value:i,onChange:a=>s(a.target.value)}),Te("button",{type:"submit",children:Te("h1",{children:"\u2709\uFE0F"})})]})]})}function W$(t){const{text:e,uid:n,photoURL:r}=t.message,i=n===Ri.currentUser.uid?"sent":"recieved";return di("div",{className:`message ${i}`,children:[Te("img",{src:r||"logo.png"}),Te("p",{children:e})]})}kd.createRoot(document.getElementById("root")).render(Te(Td.StrictMode,{children:Te(B$,{})}));
